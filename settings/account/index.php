...
<head>
    <title>Configurações da conta - FasipeX</title>
    <meta charset='UTF-8' />
        ...
        <div class='main'>
            ...
            <div class='setting-head'>
                <div class='account-text active'>
                    <a class='bold' href='<?php echo BASE_URL?>settings/account'>Conta</a>
                </div>
                <div class='password-text'>
                    <a href='<?php echo BASE_URL;?>settings/password'>Senha</a>
                </div>
            </div>
                ...
                <div class='inner-righter'>
                    <div class='acc'>
                        <div class='acc-heading'>
                            <h5>Mude as configurações básicas</h5>
                        </div>
                        <div class='acc-content'>
                            <form id='account-form' method='POST'>
                                <div class='acc-wrap'>
                                    <label class='ml-3' for=''>Nome de usuário</label>
...
-->
                                <div class='acc-wrap'>
                                    <div class='acc-right mt-3'>
                                        <button class='new-btn' type='Submit' id='save' name='submit' value='Save changes'>Salvar</button>
                                    </div>
